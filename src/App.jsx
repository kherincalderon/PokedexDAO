...
const voteModule = sdk.getVoteModule(
  "0x18b4ad3b4f1AcBDBeA7B97e8844b0D01cD4bD424",
);
...
const App = () => {
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🦄 PokédexDAO Member Page</h1>
        <p>Congratulations on being a PokédexDAO member!</p>
        <div>
          <div>
            <h2>😎 Member List</h2>
  ...
  return (
    <div className="mint-nft">
      <h1>Mint your free 🦄 PokédexDAO Membership NFT</h1>
      <button
        disabled={isClaiming}
        onClick={() => mintNft()}
      >
